...
function t2() {
  ...
  document.querySelector(".out-2").innerHTML = row;
}
...
function t3() {
  ...
  document.querySelector(".out-3").innerHTML = row;
}
...
function t4() {
  ...
  document.querySelector(".out-4").innerHTML = row;
}
...
// от 1 до 17 c шагом 1. Разделитель - знак подчеркивания и звездочка (если число нечетное, и две звездочки
