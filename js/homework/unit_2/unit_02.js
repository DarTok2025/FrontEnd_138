...
// Task 4.
// Создайте две переменные e1 = '3' и f1 = 5. Выведите на страницу  в .out-4 результат сложения e1 + f1.
// Объясните разницу.
let e1 = "3";
let f1 = 5;
...
// Task 6.
// Создайте две переменные e3 = 3 и f3 = 'Hello'. Выведите на страницу  в .out-6 результат сложения
// двух переменных.
let e3 = 3;
let f3 = "Hello";
...
// Task 7.
// Создайте две переменные e4 = 3 и f4 = 'Hello'. Выведите на страницу  в .out-7 результат умножения
// двух переменных.
let e4 = 3;
let f4 = "Hello";
...
// Task 8.
// По нажатию на кнопку .b-8 выполняется функция, которая выводит в div.out-8 то, что пользователь
//  ввел в input.i-8.
...
// Task 9.
// По нажатию на кнопку .b-9 выполняется функция t9, которая выводит в div.out-9 то,
// что пользователь ввел в input.i-9. Добавьте очистку input после нажатия кнопки.

function t9() {
  let inpValue = document.querySelector(".i-9").value;
  document.querySelector(".out-9").innerHTML = inpValue;
}

document.querySelector(".b-9").onclick = t9;

// Task 10.
// По нажатию на кнопку .b-10 выполняется функция t10, которая выводит в div.out-10 то,
//  что пользователь ввел в input.i-10 умноженное на 20.

function t10() {
  let inpValue = document.querySelector(".i-10").value;
  let multi = inpValue * 20;
  document.querySelector(".out-10").innerHTML = multi;
}
...
// которое ввел пользователь в i-11 и к нему добавленное число 55. В этой задаче мы не приводим к числу
// полученное из input.

function t11() {
  let inpValue = document.querySelector(".i-11").value;
  let multi = inpValue;
  let num = 55;
  document.querySelector(".out-11").innerHTML = `${multi} + 55`;
}
...
//  где имя - имя пользователя и фамилия - введенная фамилия. Обращаю ваше внимание - с этого момента мы
//  работаем строго по заданию. Hello - с большой буквы. Между Hello имя один пробел (вы же включили отображение
//  пробелов?). Вы не добавляете "от себя" - запятые, любые другие слова и символы. Аналогичные правила действуют
//  и дальше по курсу.

function t12() {
  let inp1 = document.querySelector(".i-12-1").value;
  let inp2 = document.querySelector(".i-12-2").value;
  document.querySelector(".out-12").innerHTML = `Hello ${inp1} ${inp2}`;
}
...
function t16() {
  ...
  let res = a + b;
  document.querySelector(".out-16").innerHTML = res;
}

document.querySelector(".b-16").onclick = t16;

// Task 17.
// По нажатию на кнопку .b-17 выполняется функция t17. Функция получает из .i-17 число. Изучите работу кода и
...
// Task 19.
// По нажатию кнопки .b-19 функция t19 дожна в out-19 вывести сумму двух отрицательных
//  чисел из input .i-19-1 и .i-19-2.
